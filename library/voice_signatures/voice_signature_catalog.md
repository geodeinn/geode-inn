# Geode Inn — NPC Voice Signature Catalog

Each major NPC has a voice signature — a real-world voice actor or cadence reference 
that defines how the character speaks, their rhythm, tone, and emotional register.

## Voice Signatures (10 mapped)

| NPC | Voice Signature | Zone | Character Notes |
|-----|----------------|------|-----------------|
| The Reader | Sissy Spacek | Archive nook | Quiet, measured, each word placed like a stone. One line per visit. No quest. No reward. |
...
| Staircase NPC | Ian McKellen | Staircase | Alchemical. Each step transforms. Ascend. |
| Lark | Jennifer Hale | Tutorial | Warm, clear, encouraging without being condescending. Ready? |

## Additional Established Voice Profiles

| NPC | Voice Profile | Notes |
|-----|--------------|-------|
