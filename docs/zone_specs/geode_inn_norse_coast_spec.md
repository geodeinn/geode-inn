# THE NORSE COAST
## The fjords. The year instead of the day. The sky's own lava lamp.
### World map zone (Project Bible's 8: Norse Coast; world grid: The Fjords = Edvard Munch, extended from the Norse zone). Written 2026-09-10, the audit's missing-spec sweep.
### Canon sources: the Norse material/recipe corridor (Pine, Birch, Bog Iron, Runestone, Amber, Heather  all live; the Turf Pit House-to-Stave Church chain in BuildingRecipe), the world grid's Munch assignment, the Beat Line (Zeke's tide clock runs all seas), the Dark Side master spec (the lava lamp chamber), D16 (the 7.83Hz parent frequency), the memory-lamp canon, the Einherjar HOLD (the Valhalla layer pass pending  respected). Six-writer gate. Five directors.

---

## WHAT THE ZONE IS
The Norse Coast is the zone where THE YEAR replaces the day as the clock. The polar cycle is the mechanic: the midnight sun (the summer that never darkens  the sleepless light, when the play changes because nothing ends) and the polar night (the winter that never brightens  the lamps' season, the memory-lamps' cousins burning on the fjord). **THE DARK IS THE PRICE OF THE LIGHTS:** the aurora season is the polar night's gift. The zone teaches the Inn's gentlest hard truth: some things only come to those who wintered.

**THE AURORA (the zone's thesis and the game's biggest tie):** the science  the solar wind meets the magnetosphere and the sky burns green. THE PLANET'S OWN PRISM: the aurora is the Earth doing what the Dark Side chamber does  frequency made visible. The 7.83Hz hum's light show. THE DARK SIDE WAS BUILT BECAUSE OF THE AURORA: the lava lamp chamber is the aurora you can walk inside (the Inn's innermost room is a model of the sky over this coast). D16's parent-frequency law, painted on heaven.

**FREQUENCY:** the polar cycle (the year's clock). The aurora's own hum (the real thing: auroras produce sound  the science is the lesson). The heartbeat runs thin here  50 BPM at the world's edge, carried by memory-lamp light.
**AESTHETIC:** EDVARD MUNCH (per the world grid  CONFIRMED ASSIGNMENT): the fjord melancholy, the long dusk, the sea that owns everything. The Scream becomes the WIND  the anxiety externalized and honored (the player never screams; the fjord-wind does. The zone where the game says: it's okay to feel small  the awe that watches you back is Friedrich's cousin and Munch's own). Munch's palette: the sick-green sky made gentle, the black fjord, the yellow house light.

---

## THE SCIENCE (the lesson)
- THE SKREI: the winter cod migration that built a nation  the stockfish (dried cod) that fed medieval Europe (the protein road: the Silk Road's cousin, freight of fish). The cod's liver oil: vitamin D  THE SUNSHINE IN A FISH, the polar night's survival medicine (the north's answer to the dark was inside the fish all along).
- THE RUNES AS GUESTBOOK: the real Viking graffiti  "Halfdan carved these runes" in Hagia Sophia's marble (the warriors' travel tags). Most Viking runes are name-calls and jokes  the internet comments of the 800s. The human continuity is the lesson.
- THE KNARR: the cargo ship  the crossing, the trade run, the wind and the tide (the Beat Line's clock runs this sea too: Zeke's chart is honored here).
...
1. **THE AURORA THESIS**  the Dark Side chamber is the aurora you can walk inside (the Innermost-room-as-model-of-the-sky canon): confirm  this is load-bearing for the whole game's frequency story
2. **MUNCH'S PALETTE**  the world grid assignment confirmed (the Scream as the wind, the anxiety honored)
