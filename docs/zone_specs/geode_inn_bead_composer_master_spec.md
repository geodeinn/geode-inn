...
| Education Mode | Faceting rules explained. Audio theory for jewelry. Luna's design principles as interactive tutorials. The app teaches the craft while you use it. |
...
| The Novel | Luna's workshop (Level 4) IS the Bead Composer's tutorial layer. |
...
- [ ] Education Mode tutorials (Luna's design principles)
