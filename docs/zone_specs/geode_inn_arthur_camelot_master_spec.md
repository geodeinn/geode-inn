# KING ARTHUR & THE CAMELOT ZONE — Master Specification
## Three Generations of Skarsgård — The Once and Future King

---

## WHAT THE ARTHUR/CAMELOT SYSTEM IS

King Arthur, the Camelot zone, and the Gustave Moreau aesthetic form an integrated character + zone + art system. Arthur is the Inn's first multi-actor, multi-age character — three Skarsgård actors (Bill, Alexander, Stellan — father and sons) playing one king at three stages. Camelot is the Celtic zone's architectural expression — the Book of Kells at building scale. Moreau is the lens: mythology not as story but as REVELATION.
...
## THE CAMELOT ZONE: MOREAU'S SACRED GEOMETRY

### Why Moreau

Moreau saw mythology not as story but as REVELATION — the image as a door, the ornament as a key, the surface as a veil that both conceals and reveals the sacred underneath. Moreau's paintings are not illustrations of myths. The paintings ARE the myths — the events happening again on the canvas.

| Moreau Quality | Camelot Application |
|---------------|-------------------|
| Jewel-like surfaces | Every wall ENCRUSTED — gold leaf, mineral cabochons, Celtic interlace. The ornament IS the content. The jewel IS the word. |
| Mythological subjects as sacred moments | Camelot is not historical. Camelot is the MYTHOLOGICAL moment — the divine breaking through the human. The sword in the stone. The Round Table. The Grail. Each one a Moreau painting: the instant the mythological becomes real. |
| Hidden symbols | The walls are TEXTS — readable by the initiate, beautiful to the uninitiate. The sacred geometry carries meaning beyond visual appearance. |
| Dreamlike precision | Architecture is impossible. Scale is wrong. Light is interior. The dreamlike is not vague — it's PRECISE. Moreau's dream is as detailed as reality, but the details don't obey reality's rules. |

### The Architecture
Gothic vaulting (the structural frame) covered with Celtic interlace (the ornamental skin) inlaid with mineral cabochons (the jewels) and gold leaf (the sacred metal). The walls are not blank. The walls are ILLUMINATED MANUSCRIPTS at building scale — the Book of Kells expanded into a room you walk through.
...
|---------|-----------|----------|
| The Camelot ambient | 42Hz (the Song, filtered through Celtic stone) | The Celtic zone's expression of the Song — the frequency in knotwork form |
| The Round Table | 42Hz resonance (the table as frequency circle) | The table IS a stone circle — the Fae Kingdom's architecture in wood and stone. The Round Table and the Fae stone circles are the same shape, the same frequency. |
| The Sword in the Stone | A single, clear tone when the sword is pulled | The act of pulling = the act of naming = the Inn's saving mechanism. The sword rings at 42Hz when freed. |
| The Grail | Near-silence (the Grail is the opposite of noise) | The Grail is the quest for stillness. The Grail's frequency is the absence of frequency — the zero point, the rest. |
...
- [x] Three Arthur stages designed (Bill/Alexander/Stellan Skarsgård)
- [x] The Camelot zone aesthetic (Moreau) specified
- [x] The Round Table architecture documented
- [x] The Old King's final quest (sitting) designed
- [x] Frequency system mapped
- [x] 8 connections to major systems documented
- [x] The Sword in the Stone as naming mechanism established
- [ ] Three Arthur character models (Bill/Alexander/Stellan, same blood at different stages)
- [ ] Camelot environment (Gothic vaulting + Celtic interlace + mineral cabochons + gold leaf)
- [ ] The Round Table as frequency circle
- [ ] The Sword in the Stone quest sequence
- [ ] The Old King's sitting quest
- [ ] Moreau-style ornament implementation (every surface a readable text)
- [ ] The Grail quest (the quest for stillness)

---

## ORIGIN

The Arthur/Camelot system was first designed in docs/geode_inn_arthur.md (81 lines) and docs/geode_inn_camelot_moreau.md (100 lines). This consolidated specification was compiled September 2, 2026. The system's thesis: the boy didn't know he was a king. The boy just tried. The trying is the boy. The king remembers being the boy. The remembering is the compassion. The old king knows that the table is round and the knights are gone and the table remains. The table is the adequate. The sitting is: the acceptance that the table is round and the king is one of the knights and the knights are gone and the table remains. The adequate is: the round table. The round is: the adequate. The both are: the same. The same is: the once and future. The future is: the sitting. The adequate is: the king who sits.
