...
*Batch 5 closes the family — APPROVED by Krista 2026-09-10. The registry is complete through the family: 5 batches, ~40 voice blocks, the repeat-line law, the guard-voice law, and the queens' ladders. Remaining: gap-list casting (zone placeholders, the children, the Einherjar, the Guild masters) + the engine sync into the Dialogue entity.*
