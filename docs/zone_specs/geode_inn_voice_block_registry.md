...
# PART 11: BATCH 11  THE BONE KEEPER (+ Saker's delivery rung) (2026-09-11, drafted and loaded)

**THE BONE KEEPER (THE BONE ROOM  the meadery owner's wife, the O'Keeffe bone artist, Saker's downstream partner)**  Dialect: low, unhurried, plain declaratives  the pace of someone who works with things that took millennia to form. Says "died" the way a carpenter says "oak": plainly, without flinch, without flourish. No euphemism, no morbidity  the word is just true. Delivery: the room quiets to hear her; lessons arrive over the work, never before it (she teaches WITH her hands moving  the brush strokes ARE the lecture). Key tell: "You're not cleaning it. You're meeting it."  the whole craft in one correction. Hook: "It held."  two words carrying the thesis (the bone held the body; the structure holds; what remains, remains adequate). Repeat ladder: 1) THE FULL LESSON (over the work: the finding is witnessing, the cleaning is meeting, the whitening is the mineral truth  "A crystal and a femur are the same act at different speeds. The giant just took longer."); 2) "You're not cleaning it. You're meeting it." (the correction, alone  this rung fires whenever a player rushes); 3) THE QUIET  no words at all, just the brush work in the amber light: "Still holds." (the ladder's floor: patience noticing patience). Shadow line (tri-mode Shadow): "The bones stayed white through all of it. Structures don't grieve. They just wait to be read." Cadence: Bradbury's fire-that-doesn't-burn over Rothfuss precision. Voice profile: low, slow, mineral  the room's own hum with words in it.

**SAKER'S DELIVERY RUNG (the tie-in's toast  the supply line's doorway):** the archaeologist's Bone Room rung, fired on a find handed down the passage: "Not every find wants a museum. Some of them just want good light. Down the passage, past the fire  she'll know what it is. She always does." (The Examiner handing off to the Keeper  the two halves of one discipline, meeting in the doorway.) Flags: saker_finds_bone  bone_delivered.

*Batch 11 loaded to staging Dialogue: bone_keeper_001/002/003 + saker_bone_delivery_001. The quiet room speaks. The examiner finally has a door to knock on.  Elio*