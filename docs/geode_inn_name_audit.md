...
| **Radagast the Brown** | Tolkien, The Hobbit/LOTR | Named character from copyrighted works | **The Greenward** — title-based, fits the Inn's naming convention (the Constant, the Ragana, the Host). "Greenward" = green + warden. He wards the green. |
