...
2. **THE KEEPING MEDALLION** — a father's compressed ashes wrapped like a pirate's medallion so it could become part of his garb. Pure Inn theology in one order: the keeping is a privilege; the dead carried, not cleared. The pirate's-medallion form points at Zeke's dock before a single panel is drawn (the customer Krista knows would be tickled — the blessing is already half-given). THE MAKER'S TESTIMONY (2026-09-14, kept in the record): her hands went NUMB FOR TWO HOURS after finishing the wrap — the only other object ever to do that was a sneaked touch on an ancient medieval church pew. THE BUTTON PANEL WRITES ITSELF: the selkie at the bench, medallion finished, shaking out her hands — wordless. No caption. Some panels just show what the work costs.
