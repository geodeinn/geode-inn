# THE GEODE INN — NEW CHARACTER ROSTER
## The Friends, Family, and Creatures Round
### August 30, 2026

This document adds all remaining NPCs and creatures to the Geode Inn. Every friend, every family member, every animal companion. The Inn's doors are open.
...
## Rachel Kaiser — The Muralist
### Studio Artist, Ceramic Tilemaker, Stardew Valley Farmer

**Real name:** Rachel Kaiser. Volunteer NPC. Real artist — muralist, ceramic tilemaker, welder, woodcarver, painter. Arizona-based, 30-year art professional. Created murals throughout the Southwest, handcrafted tile installations, hand-carved wooden sculpture. BFA in painting. Work inspired by nature and harmony.

**The person:** Rachel worked at Krista's shop for years. She is a dear friend. She is a serious artist with a 30-year career — large-scale murals, ceramic tiles, woodcarving, welding. Her art is inspired by nature and harmony, which in the Inn means: inspired by the Inn-Tree and the 42Hz Song.

**The makeup:** Rachel takes hours every morning to "put her face on." The irony — she is beautiful before doing anything. But the transformation is its own art form. She could make her living doing visual transformation videos — the kind where someone goes from "oh, you're pretty" to "dear gods, you are a walking masterpiece." Then she sets it all in place with a layer of rave hairspray. Krista, a woman who spent years depending on image representation but is always a creature of comfort, looks at this process and says: "...why?" The answer is: because it's art. The face is a canvas. The morning is the studio. The transformation is the piece.

**In the Inn:** Rachel needs two things: a room with art supplies and a place to play Stardew Valley.

**Rachel's Studio:** A room in the Spiral Gallery — the Inn's museum extension. The studio is messy in the way that only a working artist's space can be messy — organized chaos, paint on everything, ceramic tiles in various stages of completion, woodcarving tools on every surface. The room SMELLS like linseed oil and clay and sawdust. It is the most alive room in the Inn because everything in it is in progress. Nothing is finished. Everything is becoming.
...
**Appearance:** Rachel in the Inn looks like Rachel in real life — an artist. The kind of artist who is covered in her own work. Paint on her hands, clay under her nails, sawdust in her hair. The makeup is either fully on (the walking masterpiece, the transformation complete, the rave-hairspray-sealed look) or fully off (the beautiful-before-anything face, the creature of comfort, the "why?" that Krista asks). No middle ground. Rachel is either the painting or the painter. Never both at the same time.

**Personality:** Warm. Real. The friend who worked at your shop for years and became family. Rachel is the kind of person who says what she thinks, makes what she feels, and doesn't apologize for either. She has no patience for pretension and infinite patience for craft. She will spend 30 hours on a mural and 0 seconds pretending she's not proud of it.

**Accent:** American. Direct. The cadence of someone who has spent 30 years talking to clients, contractors, and gallery owners — clear, confident, with the occasional desert drawl.

**Role in the Inn:**
1. **Spiral Gallery Artist-in-Residence** — Rachel's studio is in the Spiral Gallery. Her murals and tiles are the gallery's rotating exhibits. New work appears between visits — the gallery is never the same because Rachel is always making.
2. **Ceramic Tile Crafting** — Rachel's ceramic tiles connect to the Inn's crafting system. Players can earn tiles as decorative items. Special tiles (made from the Inn-Tree's shed bark, fired in the studio kiln) carry resonance — they vibrate at 42Hz when placed near the fire.
3. **The Stardew Valley Easter Egg** — Rachel's laptop is an in-game interactive object. Players who find the studio can "play" Stardew Valley — a mini-game-within-a-game that pays homage to the farming genre. The Stardew session is a moment of calm — no quests, no combat, no frequency. Just farming. The both are: the adequate — the Inn's epic scope and the farm's small scope, the same comfort, different scale.

**Voice sample:** "I've been doing this for thirty years and I still don't know if I'm a painter who does ceramics or a ceramicist who paints or a woodcarver who welds or just a person who can't sit still. ...The mural's not done. The mural is never done. That's not a problem. That's the point. ...Yes, I'm playing Stardew Valley. No, you can't have the laptop. Get your own farm."
...
## Marion — The Game Tester
### MTG Strategist, Tabletop Veteran

**Real name:** Marion. Volunteer NPC. Game tester, MTG player, tabletop veteran.

**The person:** Marion is a game tester — someone whose job is to break games so players don't have to. Marion does MTG (Magic: The Gathering) and tabletop. Krista has a character write-up from Marion that will be provided separately.

**In the Inn:** Marion is the Inn's QA tester — the character who stress-tests the games, the puzzles, the quests, the mechanics. If there's a way to break a game, Marion finds it. If there's an exploit, Marion discovers it. If there's an edge case the designers didn't think of, Marion IS the edge case.

**Appearance:** TBD — awaiting Marion's character write-up. Placeholder: the aesthetic of a game tester — comfortable, practical, the kind of person who carries a notebook full of bug reports and dice in every pocket. The MTG connection suggests a strategic mind — someone who thinks in combos, in interactions, in "what happens if I do this AND this at the same time."
...
**In the Inn:** TBD — Krista will provide Maddi's specs. "She needs a certain type of character build." This profile is a placeholder. What we know:
- Maddi is Zack's partner
- Maddi will work for the Geode Inn once the game has momentum
- Maddi may become a storyline character
- The character build needs to be specific — not a generic NPC, but a designed character with a particular role
...
## Zack — Playable Version
### The Astronomer as Player Character

Zack already exists as an NPC — the Astronomer, the cosmology level's resident genius, the playthrough tester. A PLAYABLE version means Zack can be selected as a player avatar, not just interacted with as an NPC.

**The Playable Astronomer:** When playing as Zack, the player has access to the Mind Palace mechanic — the ability to navigate the cosmology level's architecture as a thought process. Rooms are thoughts. Corridors are connections. Staircases are deductions. The playable Zack turns the cosmology level into a navigable consciousness.

**Starting zone:** The Observatory (cosmology level).
**Signature ability:** Allfather's Gaze (early version) — Zack can see connections between objects, zones, and NPCs that other player characters can't. The connections are visible as faint lines of light — the 42Hz Song's pathway through the Inn.
**Questline:** The Observatory Quest Chain (the existing cosmology quest chain, now playable from inside the mind palace rather than from outside it).
**Limitation:** Zack starts in the cosmology level and must earn the ability to descend to other floors. The Astronomer lives in the sky. Coming down to earth is a journey, not a given.

**Connection to Maddi:** Maddi is the grounding wire. If the player chooses Zack, Maddi appears as an NPC who sends messages — "Have you eaten?" "The sky will be there tomorrow." "Come downstairs." The messages are the playable Zack's connection to the ground. Ignoring Maddi has consequences — the Astronomer who doesn't come down from the Observatory starts losing track of time, and the Mind Palace starts looping.

---

# PART TWO: ANIMALS AND CREATURES

---

## The Maine Coon Colony

A colony of Maine Coon cats lives in the Inn. Not one or two — a whole group. They are the Inn's largest cats (Maine Coons are the largest domestic cat breed), and in the Inn, they are the closest thing to natural dragons.

**Appearance:** Large, long-haired, tufted ears, bushy tails, the look of small lions. Each is a different color — the colony has greys, browns, tabbies, tortoiseshells, one pure black (who may or may not be Stephanie in disguise — nobody has been able to confirm this).

**Where they live:** Everywhere. Maine Coons are territorial but social — the colony has members in every zone. One in the main floor (the hearth cat, who sleeps on the fire stones). One in the Campgrounds (Jay's wolf has a complicated relationship with the Campgrounds Maine Coon — they ignore each other with great dignity). One in the canopy (Kathy's favorite, who sits on her shoulder — the Cabbit has opinions about this). One in the catacombs (the largest, a grey male who patrols the bone rooms with slow, heavy steps). One in the Fae Kingdom (the Seelie Court's Maine Coon, who has been mistaken for a Fae creature and doesn't correct anyone). One in the Tidal Caves (who fishes in the tide pools with paws the size of catchers' mitts).

**Behavior:** Maine Coons are known for being dog-like — they follow people, they play fetch, they chirp and trill instead of meowing. In the Inn, this translates to: the Maine Coon colony is the Inn's ambient companion system. They follow players. They chirp at doors. They bring gifts (a mouse, a leaf, a small stone, a dropped charm). They are the Inn's way of saying "you are noticed" without the Whisper Layer's heavier implications. The Maine Coons are the gentle version of the Inn's awareness.

**Fae Connection:** Some Maine Coons can become Fae if they choose to. This is the Selkie's companions' ability (Peach and Bella, below), but it extends to the colony — any Maine Coon in the Inn, given enough time in a Fae zone, can develop Fae awareness. The Fae Maine Coons are larger, their eyes glow, and they can move between the Seelie and Unseelie courts freely. The both are: the adequate — the cat and the Fae, the same creature, different awareness.

---

## Savannah Cats — The Baby Dragons

Savannah cats are a real breed — a hybrid of domestic cat and serval, with spotted coats, large ears, and a wild look. In the Inn, they are "baby dragons." Not literally — but in appearance, in attitude, in the way they move. The both are: the adequate — the cat and the dragon, the same creature, different myth.
...
Small crocodilians. In the Inn, they live in the water zones — the Tidal Caves' shallows, the Atlantis perimeter, and the Bayou zone's swamp water.

**Appearance:** Mini crocodiles. Not the massive saltwater kind — the small, spectacled kind, with ridged backs and patient eyes. They look like they're frowning, but they're actually just being caimans. The frown IS the caiman.

**Behavior:** They sit. They wait. They are the patience of the water zones expressed in reptile form. They don't attack. They don't interact. They just... are. Sitting on rocks. In the shallows. Being caimans. For hours. For days. The Selkie has named all of them. There are fourteen. The names are: First Caiman, Second Caiman, Third Caiman, and so on. The Selkie is not creative with caiman names. The caimans don't mind. They don't know their names. They are caimans.

**The Frog Gargoyle connection:** The caimans share the water zones with the frogs. The frogs sit on the caimans' backs. The caimans don't notice. This is the water zones' gentlest interaction — small frogs riding patient crocodilians through tide pools like commuters on a bus.

---

## Bearded Dragons — The Oversized Sweethearts

Bearded dragons that are too big for a bearded dragon but keep the clever, laid-back, sweet personality. In the Inn, they are the Undercity's gentle giants — large lizards with calm energy, the reptile equivalent of a golden retriever.
...
A Canadian grizzly bear who just wants a quiet place away from tourists who keep thinking it should be a mean thing to be feared. This is the bear's entire character: it is not mean. It is not fearsome. It is a grizzly who wants to be left alone. Not in an aggressive way — in an introverted way. The both are: the adequate — the grizzly and the introvert, the same bear, different reputation.

**In the Inn:** The Canadian grizzly lives in the deepest part of the Campgrounds — the zone farthest from the tavern, farthest from the market, farthest from the tourists. It has a clearing. The clearing has a stream. The stream has fish. The bear fishes. The bear eats. The bear naps. This is the bear's entire schedule. If you find the clearing, the bear looks at you with an expression that says: "...Really?" Not angry. Not scared. Just... disappointed that you found its spot.

**The quest:** The bear's "quest" is not a quest. It's a favor. The bear asks you to keep the tourists away. Not by force — by distraction. Redirect them to the tavern. Point them at the market. Give them a map to a different clearing. The reward: the bear lets you sit in the clearing. For five minutes. No talking. Just sitting. The both are: the adequate — the quest and the favor, the same task, different framing.

**Connection to the Campgrounds:** Jay knows the bear. Jay respects the bear. Jay sends loud tourists in the other direction. The wolf occasionally walks to the bear's clearing and sits at the edge. The bear and the wolf sit in silence. This is their friendship. It requires no words.

---

## The Draenei-Kangaroo

A character who looks like a Draenei (from World of Warcraft) — blue-skinned, hooved, with the crystalline, otherworldly aesthetic of the Alliance's otherworldly race. But with a twist: this character has kangaroo DNA. Normally dormant. But if you tick them off too much — if you push past the calm, crystalline, blue-skinned patience — the kangaroo emerges. The legs kick. The tail appears. The Draenei becomes a kangaroo in everything but color.

**Appearance:** Draenei base — blue skin, crystalline features, hooved legs, the elegant otherworldly look. Tall, dignified, calm. The kangaroo is NOT visible in the default state. But when provoked, the posture shifts — the legs coil, the tail manifests (crystalline, like a Draenei tail but with kangaroo function), and the kick is... significant. The both are: the adequate — the Draenei and the kangaroo, the same body, different temper.

**Personality:** Patient. Calm. Dignified. The crystalline composure of a Draenei — but underneath, the coiled readiness of a kangaroo. You don't want to see the kangaroo. The kangaroo is not polite. The kangaroo does not use words. The kangaroo kicks.

**Role in the Inn:** A guardian-type NPC in one of the zones — perhaps the exterior zones or the Campgrounds perimeter. The both are: the adequate — the guardian and the marsupial, the same protection, different method. The Draenei-Kangaroo is the guard who is calm until they're not, and when they're not, the threat is eliminated by foot.

**The humor:** The contrast IS the humor. A dignified, blue-skinned, crystalline, otherworldly being who, when pushed too far, becomes a kangaroo. The both are: the adequate — the elegant and the absurd, the same creature, different mood. This is the Inn's most visible joke about the gap between appearance and reality.
...
## Frogs — Including the Frog Gargoyle

### The Common Frogs (2-3)

Small frogs that live in the water zones and the Bayou. They are the Inn's simplest creatures — they sit, they croak, they jump, they are frogs. The beauty is in the simplicity. The both are: the adequate — the simple and the adequate, the same frog, different truth.

The caimans carry them. The frogs ride the caimans. This is the water zones' gentlest image — small frogs on patient crocodilians, riding through tide pools.

### The Frog Gargoyle

Yes. There can be a frog gargoyle.

**Appearance:** A stone frog. Gargoyle-sized — larger than a real frog, smaller than the Watcher. It sits on a ledge in the catacombs, near the water seep. Its mouth is open in a permanent croak. Its eyes are wide. Its body is the same stone as the other gargoyles — the Ent's bark-become-stone.
...
# PART THREE: THE CUSTOMIZABLE DOZEN

## The Open Twelve — For Friends

A dozen customizable character slots that can be personalized for friends of the people already in the Inn. These are not designed characters — they are TEMPLATES, waiting for the person who will fill them.

**The concept:** The Inn has room for more people. Not everyone needs a full character profile from the start. The Open Twelve are placeholder characters — bodies in the Inn, waiting for identity. When a friend wants to join, one of the Twelve becomes them.

**The Twelve Templates:**

| # | Template Name | Zone | Role | Notes |
|---|---|---|---|---|
| 1 | The Traveler | Main Floor | Visitor/wanderer | No fixed role — explores, observes, reports |
...
| 9 | The Swimmer | Water Zones | Diver | Explores the underwater passages |
| 10 | The Wanderer | Fae Kingdom | Border walker | Moves between the Seelie and Unseelie courts |
| 11 | The Builder | Canopy | Architecture student | Learns from Kathy, helps grow the Inn |
| 12 | The Reader | Common Room | Living book visitor | Leaves messages in the Common Room's living book |

**How customization works:** Each template has a base appearance (generic, cel-shaded, Inn-appropriate) and a zone assignment. When a friend claims a slot, their real name, personality, and preferences overwrite the template. The template's zone and role can shift based on the friend's interests. The both are: the adequate — the template and the person, the same slot, different soul.

**The Open Door:** The Twelve are the Inn's open door. "We have room for you. Come in. Tell us who you are. We'll build you a place." The both are: the adequate — the structure and the welcome, the same Inn, different guest.
...
| Caimans | Creature Group | Water zones — Patient crocodilians |
| Bearded Dragons | Creature Group | Undercity — Oversized sweethearts |
...
*"The Inn has room for more people. The doors are open. Come in. Tell us who you are. We'll build you a place."*

**END OF NEW CHARACTER ROSTER**
