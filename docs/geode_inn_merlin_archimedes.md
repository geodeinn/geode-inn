...
Merlin lives backwards through time. He experiences time in reverse — he has already lived the future and is moving toward the past. He knows what's going to happen because he's already been there. He doesn't always remember the details, because living backwards means the memories are fading in the *other* direction — the future he's already lived is getting dimmer as he moves toward the past he hasn't experienced yet.
...
- **Eccentric.** Not performatively eccentric — genuinely, thoroughly, unapologetically *weird.* The kind of weird that comes from knowing the future and living in the past and being unable to explain either to anyone. He talks to himself. He loses things. He finds things he hasn't lost yet. He packs for trips he's already returned from.
- **Brilliant.** The deepest kind of brilliant — the kind that sees connections no one else sees because he's seen both ends of the pattern. He knows where the Song of Making goes because he's already heard the ending. He can't always remember the ending clearly, but the *shape* of it is there, like a melody you can hum but can't name.
- **Funny.** The Disney Merlin humor — bumbling, self-deprecating, the comedy of a man who is always one step ahead (because he's going backward) and still manages to trip over his own beard. The humor is the kindness — Merlin uses comedy the way the Host uses welcome: to make the terrifying (knowing the future, living backward, transformation) feel approachable.
- **Warm.** The warmth of a teacher who genuinely loves his students. Merlin's warmth is not the Host's warmth (safe, anchoring). Merlin's warmth is the warmth of someone who knows you're going to be fine (because he's seen your future) and is trying to help you get there without telling you the answer (because telling you would rob you of the learning). The warmth is the *patience* — the willingness to let you struggle toward a future he already knows.

### The Forgetting

The tragedy of Merlin: the future is fading. Every day he lives backward, the future he came from gets a little dimmer. He knows the Inn's purpose. He knows the merging's outcome. He knows what the Song of Making becomes. But the details are going — like a book whose pages are blanking from the back toward the front. He's racing his own forgetfulness, trying to teach what he knows before he forgets what he knows.
...
- Flowing. Wandering. The speech of someone who is thinking in a different temporal direction and occasionally trips over the present.
- Funny. The Disney Merlin humor — self-deprecating, distracted, the comedy of a man who packs for a trip he's already returned from.
- Profound in the pauses. Merlin says something silly, then something devastating, then something silly again, and the player doesn't realize the devastating part was devastating until three quests later.
...
The Camelot zone's core gameplay is Merlin's transformation quests:

1. **Fish** — the player becomes a fish. Learns the water layer from inside. The fish can reach parts of the water layer that the player can't reach as a person — the deep currents, the thermoclines, the places where Charon's river connects to the open water. The fish transformation is the first step toward the underwater traversal layer. The player who has been a fish navigates water differently forever after.

2. **Bird** — the player becomes a bird. Learns the Bifrost (staircase) from above. The bird can fly the staircase in seconds instead of minutes. The bird sees the zones from above — sees the layout, the connections, the geography that walking doesn't reveal. The bird transformation is the first step toward the world map's full exploration.

3. **Stone** — the player becomes a stone. Learns time. The stone doesn't move. The stone sits. The stone experiences the Inn's time at a different speed — hours become seconds, seasons become breaths. The stone sees the Inn-Tree's root system growing. The stone sees the pomegranate tree's roots reaching down. The stone sees the 42Hz hum as vibration in the bedrock. The stone transformation is the first step toward understanding the Song of Making.
...
Merlin is not part of the Council of Thinkers (Tesla, Da Vinci, Newton, Einstein). The Thinkers measure the Song. Merlin *hears* it. The distinction:

- Tesla measures the 42Hz hum. He doesn't know it's a song.
- Da Vinci sees the Song as visual patterns. He doesn't know it's a song.
- Newton calculates the laws the Song follows. He doesn't know it's a song.
- Einstein feels the Song as warmth. He doesn't know it's a song.
- Merlin *knows* it's a song. He's heard the ending. He's forgetting the ending. But he knows. He's the only character in the Inn who knows, completely and certainly, that the 42Hz hum is a Song. He can't always remember the melody. But he knows it's music.
