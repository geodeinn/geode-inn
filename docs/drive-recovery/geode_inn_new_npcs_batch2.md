...
### 1. Jakob — River's Son
- **Relationship:** River's son, lives in Australia
- **Visual:** Tall, wild black hair (untamed, voluminous), burly build, olive complexion (inherited from River)
...
- **Relationship:** Jakob's mother, connected to River
...
- **Real Name:** Dani (NPC name: Solstara — chosen 2026-09-03; flowing hippie/fae, rave-glitter energy)
...
```
          ...
          (Sentinel)    (River's son)
              
    CHARLES (The Constant) ──── JAY (best friend) ──── DANI (good friend, fellow jeweler)
```

## OPEN QUESTIONS
- How does River connect to Alexia? (Co-parent? Partner? Family?)
