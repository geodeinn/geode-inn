# Build Sheet — Terracotta Army Builder

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Terracotta Army Builder |
| Genre/Mechanic | Pikmin × China. Command terracotta soldiers. |
| Zone | China |
| Stone Reward | Jade |
| Rarity Tier | Rare |
| Price | $3.99 |
| Game Effect | Unlocks Jade. |
| Lore Connection | China's terracotta army. Strategy because armies are placement. Jade is the stone of command. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Pikmin × China. Command terracotta soldiers.

The player engages with China's mythology and geography through gameplay. China's terracotta army. Strategy because armies are placement. Jade is the stone of command.
...
- Background: China environment in assigned artist style
