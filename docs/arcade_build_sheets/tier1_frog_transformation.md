# Build Sheet — Frog Transformation
...
| Lore Connection | The Inn's community moderation system. Social deduction because communities need trust. Free because moderation is everyone's responsibility. Three transformations = suspension. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Among Us × Inn. Social deduction, 3 transforms = suspension.

The player engages with Inn's mythology and geography through gameplay. The Inn's community moderation system. Social deduction because communities need trust. Free because moderation is everyone's responsibility. Three transformations = suspension.

Stone Reward: None (Common) — earned through completion.
...
- Background: Inn environment in assigned artist style
