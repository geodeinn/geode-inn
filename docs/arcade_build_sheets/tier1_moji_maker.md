# Build Sheet — Moji Maker

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Moji Maker |
| Genre/Mechanic | Little Alchemy × Easter Island. Combine elements to create. |
| Zone | Easter Island |
| Stone Reward | Obsidian |
| Rarity Tier | Uncommon |
| Price | $2.99 |
| Game Effect | Unlocks Obsidian. |
| Lore Connection | Easter Island's moai are the Inn's observers. Little Alchemy mechanics because creation is combination. Obsidian is volcanic glass — the moai's eye stone. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Little Alchemy × Easter Island. Combine elements to create.

The player engages with Easter Island's mythology and geography through gameplay. Easter Island's moai are the Inn's observers. Little Alchemy mechanics because creation is combination. Obsidian is volcanic glass — the moai's eye stone.

Stone Reward: Obsidian (Uncommon) — earned through completion.
...
- Background: Easter Island environment in assigned artist style
- UI: Antikythera-themed HUD, gold/brass on dark stone
- Stone reveal: Obsidian shard animation on completion
...
- Victory: Stone tone trigger (Obsidian) at 12dB below narration
