# Build Sheet — The Reclamation

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | The Reclamation |
| Genre/Mechanic | Don |
| Zone | Bayou |
| Stone Reward | Swamp Agate |
| Rarity Tier | Rare |
| Price | $4.99 |
| Game Effect | Unlocks Swamp Agate. |
| Lore Connection | The Bayou is the Bog Fairy Golem's domain. Don't Starve mechanics because reclamation is survival crafting. Swamp Agate forms in the murky boundary between water and earth. |
...
The player engages with Bayou's mythology and geography through gameplay. The Bayou is the Bog Fairy Golem's domain. Don't Starve mechanics because reclamation is survival crafting. Swamp Agate forms in the murky boundary between water and earth.

Stone Reward: Swamp Agate (Rare) — earned through completion.
...
- Background: Bayou environment in assigned artist style
- UI: Antikythera-themed HUD, gold/brass on dark stone
- Stone reveal: Swamp Agate shard animation on completion
...
- Victory: Stone tone trigger (Swamp Agate) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Swamp Agate, increment gamesCompleted
