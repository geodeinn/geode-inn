# Build Sheet — The Arcana

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | The Arcana |
| Genre/Mechanic | Star Fox × Cosmology. Captain tests with QUIET. |
| Zone | Cosmology |
| Stone Reward | Moldavite |
| Rarity Tier | Epic |
| Price | $9.99 |
| Game Effect | Unlocks Moldavite. |
| Lore Connection | Cosmology holds the spacecraft. Star Fox mechanics because the void is navigation. Moldavite is the stone that crossed the void to get here. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Star Fox × Cosmology. Captain tests with QUIET.

The player engages with Cosmology's mythology and geography through gameplay. Cosmology holds the spacecraft. Star Fox mechanics because the void is navigation. Moldavite is the stone that crossed the void to get here.
