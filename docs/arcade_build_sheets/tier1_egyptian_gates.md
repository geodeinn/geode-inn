# Build Sheet — Egyptian Gates

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Egyptian Gates |
| Genre/Mechanic | Patapon × Egypt. 12 gates of the Duat. |
| Zone | Egypt |
| Stone Reward | Carnelian |
| Rarity Tier | Rare |
| Price | $3.99 |
| Game Effect | Unlocks Carnelian. |
| Lore Connection | The 12 gates of the Duat are Egypt's trial. Rhythm because the Book of the Dead is a song. Carnelian is the Egyptian heart stone — the warm red of the afterlife. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Patapon × Egypt. 12 gates of the Duat.

The player engages with Egypt's mythology and geography through gameplay. The 12 gates of the Duat are Egypt's trial. Rhythm because the Book of the Dead is a song. Carnelian is the Egyptian heart stone — the warm red of the afterlife.

Stone Reward: Carnelian (Rare) — earned through completion.
...
- Stone reveal: Carnelian shard animation on completion
...
- Victory: Stone tone trigger (Carnelian) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Carnelian, increment gamesCompleted
