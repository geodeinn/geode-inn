# Build Sheet — Fjord of Stars

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Fjord of Stars |
| Genre/Mechanic | Lumines × Slavic. 3 aurora phases, star mapping. |
| Zone | Slavic |
| Stone Reward | Iolite |
| Rarity Tier | Rare |
| Price | $3.99 |
| Game Effect | Unlocks Iolite. |
| Lore Connection | The Slavic zone holds the aurora. Lumines because the aurora is a falling-block puzzle of light. Iolite is the Norse compass — it sees through fog. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Lumines × Slavic. 3 aurora phases, star mapping.

The player engages with Slavic's mythology and geography through gameplay. The Slavic zone holds the aurora. Lumines because the aurora is a falling-block puzzle of light. Iolite is the Norse compass — it sees through fog.

Stone Reward: Iolite (Rare) — earned through completion.
...
- Background: Slavic environment in assigned artist style
- UI: Antikythera-themed HUD, gold/brass on dark stone
- Stone reveal: Iolite shard animation on completion
...
- Victory: Stone tone trigger (Iolite) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Iolite, increment gamesCompleted
