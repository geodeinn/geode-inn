...
**COMPLETE 2026-09-10 — 28/28 sprites (26 owed + 2 bonus breathing frames).** Full cast: froglodyte dig/pump/idle cycles, Isis Priestess (serene + manifesting), Cobra Warden (patrol/venom/inflated), Scarab Swarmer (idle/burrow/inflated). Every set carries both frequency states: living 42Hz painted masters, shadow 84Hz generated by scripted spectral shift (cool, darken, desaturate, gold-to-silt) — the tri-mode recolor class working in production. Atlas: docs/library/sprites/tomb_tunnel/tomb_tunnel_atlas_full.png. Cast proof: tomb_tunnel_cast_complete.png. TOMB TUNNEL IS THE FIRST FULLY-CAST GAME IN THE SHOP.
