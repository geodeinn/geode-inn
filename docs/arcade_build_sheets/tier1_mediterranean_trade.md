# Build Sheet — Mediterranean Trade

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Mediterranean Trade |
| Genre/Mechanic | Uncharted Waters × Mediterranean. Ancient trade routes. |
| Zone | Mediterranean |
| Stone Reward | Coral |
| Rarity Tier | Rare |
| Price | $3.99 |
| Game Effect | Unlocks Coral. |
| Lore Connection | The Mediterranean holds ancient trade routes. Uncharted Waters because trade is navigation. Coral is the sea's stone — built by tiny architects. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Uncharted Waters × Mediterranean. Ancient trade routes.

The player engages with Mediterranean's mythology and geography through gameplay. The Mediterranean holds ancient trade routes. Uncharted Waters because trade is navigation. Coral is the sea's stone — built by tiny architects.

Stone Reward: Coral (Rare) — earned through completion.
...
- Background: Mediterranean environment in assigned artist style
- UI: Antikythera-themed HUD, gold/brass on dark stone
- Stone reveal: Coral shard animation on completion
...
- Victory: Stone tone trigger (Coral) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Coral, increment gamesCompleted
