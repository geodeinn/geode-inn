# Build Sheet — The Noob Siege

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | The Noob Siege |
| Genre/Mechanic | Attack of the Noobs × Wire Nook. Defend the fizgig home. |
| Zone | Wire Nook |
| Stone Reward | Lodestone |
| Rarity Tier | Uncommon |
| Price | $4.99 |
| Game Effect | Unlocks Lodestone. |
| Lore Connection | The Wire Nook is the fizgigs' hidden home. Tower defense because home is worth defending. Lodestone is the 42Hz magnetic sprite. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Attack of the Noobs × Wire Nook. Defend the fizgig home.

The player engages with Wire Nook's mythology and geography through gameplay. The Wire Nook is the fizgigs' hidden home. Tower defense because home is worth defending. Lodestone is the 42Hz magnetic sprite.

Stone Reward: Lodestone (Uncommon) — earned through completion.
...
- Background: Wire Nook environment in assigned artist style
- UI: Antikythera-themed HUD, gold/brass on dark stone
- Stone reveal: Lodestone shard animation on completion
...
- Victory: Stone tone trigger (Lodestone) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Lodestone, increment gamesCompleted
