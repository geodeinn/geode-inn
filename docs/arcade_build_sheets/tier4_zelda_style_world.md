# Build Sheet — Zelda-Style World

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Zelda-Style World |
| Genre/Mechanic | LttP × All Zones. Living/Shadow frequency shift on ZR. |
| Zone | All Zones |
| Stone Reward | Multi-gems |
| Rarity Tier | Legendary |
| Price | $12.99 |
| Game Effect | Unlocks Multi-gems. |
| Lore Connection | The Zelda-style world is the Inn's open world — Living (42Hz) and Shadow (84Hz) frequencies shift on ZR. LttP mechanics because muscle memory is the Inn's language. Multi-gems because the world holds everything. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

LttP × All Zones. Living/Shadow frequency shift on ZR.

The player engages with All Zones's mythology and geography through gameplay. The Zelda-style world is the Inn's open world — Living (42Hz) and Shadow (84Hz) frequencies shift on ZR. LttP mechanics because muscle memory is the Inn's language. Multi-gems because the world holds everything.

Stone Reward: Multi-gems (Legendary) — earned through completion.
...
- Stone reveal: Multi-gems shard animation on completion
...
- Victory: Stone tone trigger (Multi-gems) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Multi-gems, increment gamesCompleted
