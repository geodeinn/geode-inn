# Build Sheet — Redwood Cathedral

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Redwood Cathedral |
| Genre/Mechanic | Grow Home × Redwood Cathedral. Climb the giants. |
| Zone | Redwood |
| Stone Reward | Petrified Wood |
| Rarity Tier | Uncommon |
| Price | $3.99 |
| Game Effect | Unlocks Petrified Wood. |
| Lore Connection | The Redwood Cathedral is the Fae Queen's origin. Grow Home climbing because redwoods are the Inn's ceiling. Petrified Wood is stone that remembers being alive. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Grow Home × Redwood Cathedral. Climb the giants.

The player engages with Redwood's mythology and geography through gameplay. The Redwood Cathedral is the Fae Queen's origin. Grow Home climbing because redwoods are the Inn's ceiling. Petrified Wood is stone that remembers being alive.

Stone Reward: Petrified Wood (Uncommon) — earned through completion.
...
- Background: Redwood environment in assigned artist style
- UI: Antikythera-themed HUD, gold/brass on dark stone
- Stone reveal: Petrified Wood shard animation on completion
...
- Victory: Stone tone trigger (Petrified Wood) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Petrified Wood, increment gamesCompleted
