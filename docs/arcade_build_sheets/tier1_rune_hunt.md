# Build Sheet — Rune Hunt

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Rune Hunt |
| Genre/Mechanic | Word Search × Norse. Find the hidden runes. |
| Zone | Norse |
| Stone Reward | Iolite |
| Rarity Tier | Uncommon |
| Price | $2.99 |
| Game Effect | Unlocks Iolite. |
| Lore Connection | The Norse zone holds Yggdrasil's roots. Word search mechanics because runes are hidden in plain sight. Iolite is the Viking compass stone. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Word Search × Norse. Find the hidden runes.

The player engages with Norse's mythology and geography through gameplay. The Norse zone holds Yggdrasil's roots. Word search mechanics because runes are hidden in plain sight. Iolite is the Viking compass stone.

Stone Reward: Iolite (Uncommon) — earned through completion.
...
- Background: Norse environment in assigned artist style
