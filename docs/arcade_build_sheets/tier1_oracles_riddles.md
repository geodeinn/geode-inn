# Build Sheet — Oracle's Riddles

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Oracle's Riddles |
| Genre/Mechanic | Crossword × Parthenon. Solve the oracle word puzzles. |
| Zone | Parthenon |
| Stone Reward | Sapphire |
| Rarity Tier | Uncommon |
| Price | $2.99 |
| Game Effect | Unlocks Sapphire. |
| Lore Connection | The Parthenon houses the Oracle. Crossword mechanics because prophecy is word-puzzle. Sapphire is the stone of wisdom — the Oracle's gift. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Crossword × Parthenon. Solve the oracle word puzzles.

The player engages with Parthenon's mythology and geography through gameplay. The Parthenon houses the Oracle. Crossword mechanics because prophecy is word-puzzle. Sapphire is the stone of wisdom — the Oracle's gift.

Stone Reward: Sapphire (Uncommon) — earned through completion.
...
- Background: Parthenon environment in assigned artist style
