# Build Sheet — Dragon's Descent

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | Dragon's Descent |
| Genre/Mechanic | Super Mario Bros × Lost Civilizations. A story platformer. |
| Zone | Lost Civ |
| Stone Reward | Multi-gems |
| Rarity Tier | Uncommon |
| Price | $3.99 |
| Game Effect | Unlocks Multi-gems. |
| Lore Connection | The Lost Civilization zone holds ruins beneath the Inn. Mario platforming because descent is a journey. Multi-gems because lost civilizations leave everything behind. |
| Development Status | live |

## SECTION 2: STORYLINE ADAPTATION

Super Mario Bros × Lost Civilizations. A story platformer.

The player engages with Lost Civ's mythology and geography through gameplay. The Lost Civilization zone holds ruins beneath the Inn. Mario platforming because descent is a journey. Multi-gems because lost civilizations leave everything behind.

Stone Reward: Multi-gems (Uncommon) — earned through completion.
...
- Background: Lost Civ environment in assigned artist style
