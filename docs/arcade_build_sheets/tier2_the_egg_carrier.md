# Build Sheet — The Egg Carrier

## SECTION 1: IDENTITY

| Field | Value |
|-------|-------|
| Geode Inn Name | The Egg Carrier |
| Genre/Mechanic | Yoshi |
| Zone | Canopy |
| Stone Reward | Fire Agate |
| Rarity Tier | Uncommon |
| Price | $4.99 |
| Game Effect | Unlocks Fire Agate. |
| Lore Connection | The Canopy is where eggs hatch. Yoshi's Island mechanics because carrying is caring. Fire Agate forms where sunlight meets living wood. |
...
The player engages with Canopy's mythology and geography through gameplay. The Canopy is where eggs hatch. Yoshi's Island mechanics because carrying is caring. Fire Agate forms where sunlight meets living wood.

Stone Reward: Fire Agate (Uncommon) — earned through completion.
...
- Background: Canopy environment in assigned artist style
- UI: Antikythera-themed HUD, gold/brass on dark stone
- Stone reveal: Fire Agate shard animation on completion
...
- Victory: Stone tone trigger (Fire Agate) at 12dB below narration
...
Base44 API: On completion, POST to PlayerProgress — add Fire Agate, increment gamesCompleted
