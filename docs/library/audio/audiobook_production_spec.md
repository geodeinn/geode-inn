...
| Madame Mimm | Mimicry — shifts to match whoever spoke last | Shifting | Erratic, playful, sometimes alarming |
...
**Cast:** Narrator, Crone, Catalyst (Beverley), Brownies, Madame Mimm, Sentient Pipe
**Audio Architecture:**
...
- Madame Mimm scene: voice shifts between Narrator, Beverley, and Crone — the processor tracks the last speaker's profile and Madame Mimm inherits it with a 0.5s delay. Startling, funny, slightly uncanny.
...
- Chapter 11: Madame Mimm and the Pipe — Mimicry, sentience, the question of copies
...
- **Madame Mimm:** Mimicry — inherits last speaker's profile +0.5s delay
