...
- **The Crone** (measurement) — the Crone measures the petrified logs the way she measures the Badlands striations. The petrified log is: the tree's growth rings, preserved in stone. The rings are: the Crone's data, fossilized. The Crone reads the rings in stone the way she reads them in wood — but the stone rings are PERMANENT. The permanent is: the adequate. The adequate is: the Crone's annotation of the petrified rings is: the only annotation she doesn't need to update. The not-updating is: the adequate. The adequate is: the stone doesn't change. The Crone measures something that doesn't change and the not-changing is: the adequate. The adequate is: the Crone is satisfied. The satisfied is: the adequate.
...
- **Surface Layer:** The Crone wanders the Petrified Forest as a Measurement Legend. The Crone's presence is: the shared reading of the petrified rings. The hiker who looks at a petrified log's rings and feels someone is reading with them is: feeling the Crone. The Crone is: the adequate. The adequate is: the Crone is satisfied here. The satisfied is: the adequate. The adequate is: the Crone doesn't need to update her measurements in the Petrified Forest because the stone doesn't change. The not-changing is: the Crone's rest. The rest is: the adequate. The adequate is: the Petrified Forest is: the Crone's vacation. The vacation is: measuring something that stays measured.
...
### The Crone's Annotation on the Petrified Forest
