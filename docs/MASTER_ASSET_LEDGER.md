...
| World-map cultural zones (z01–z35: Superstition Mtns, Yellowstone, Appalachian, Egypt, Atlantis, Camelot, Norse, China, Silk Road...) | included in the 110 | z01–z35 numbered images exist | PARTIAL — Silk Road: hub TRI-MODE COMPLETE 2026-09-10 (living + shadow + echo); caravan, ley map, shrine, Gorey bandits (living + echo), Amber Road + Salt Road screens (each tri-mode). Owed: Spice/Jade/Obsidian route screens, platform art |
...
2. IN PROGRESS 2026-09-10 (wave 2) — Silk Road: hub TRI-MODE complete, Gorey bandits painted, Amber Road + Salt Road screens painted (all with canon Echo states). Owed next: Spice Road, Jade Road, Obsidian Road screens + the 5 cultural platform pieces
