# THE CHARACTER SOURCE MAP
## The Master Mapping of In-Game Characters to Real-World Seeds and Storyline Roots

---

## 1. THE THESIS

The narrative interweave of the Geode Inn cannot be blueprinted through abstract design alone; the interweave exists because the character sources are realized in living human relationships. The density of the Inn's gothic, cosmic, and neuro-accessible world grows directly from real-world roots—family members, spouses, close friends, and personal canon—where authentic dynamics provide emotional weight that synthetic character design cannot simulate.

When a character is rooted in a real person, every dialogue cadence, skill, choice, and quirk carries decades of lived context. The Lichenblossom precedent () established early in development that real-world individuals and player-characters serve as anchor roots in the world structure. These real seeds produced the Inn's story density:
- The 50 BPM dock sessions between the Bard and the Pirate reflect a thirty-year real-world best friendship ().
- The quiet window scene where the Ragana and Katya watch their noisy husbands reflects a real sister-in-law bond and shared understanding ().
- The 60-year elopement of the Bard and the Ragana anchors the proof that boisterous noise and surgical precision belong together ().
- The 40Hz ocean memory of Vaulknut and the 42Hz Inn-Tree synchronization of Charles translate real physical and emotional grounding into game mechanics (, ).

Abstract worldbuilding generates systems; real seeds generate narrative gravity. Realizing the source seeds first unlocks the entire interweave blueprint.

---

## 2. THE FAMILY CORE

The foundation of the Geode Inn is built upon a polyamorous triad—Krista, Lozen, and Charles—whose partnership forms the core stability of the Inn ().
...
- **Source Seed:** Charles, spouse in the triad (, ).
- **Narrative Role & Mechanics:** Chameleon Druid class. Visual and vocal casting inspiration draws from Cillian Murphy (quiet intensity, Tommy Shelby stillness, piercing blue eyes) (). Real-world diagnosis of glioblastoma is woven into the character as narrative reality rather than metaphor (). A shapeshifter whose body changes in ways beyond personal control; finite endurance reserve (). In the garden, Charles's pulse synchronizes with the Inn-Tree's 42Hz frequency to stabilize the body ().
- **Document References:** , , .
...
The sister layer anchors the water zones and the dual-world concept (, ).
...
## 5. THE FRIENDS-AND-FAMILY EXTENSIONS

Every real-person-linked character adds a specific layer of craft, technology, lore, or community structure (, ).

### Lichenblossom (Katy)
- **Source Seed:** Katy, real-world player and friend (, ).
- **Lore & Mechanics:** Plant necromancer who reanimates plant life rather than resurrecting. Visual features include dread-antenna and Van Gogh swirl aesthetic (). Represents the Lichenblossom precedent—a real person playing a personal character in-world.
- **Document References:** , .

### The Archivist (Evan)
- **Source Seed:** Evan, close friend and tabletop player (, ).
...
### Will
- **Source Seed:** Will, married to Oceanianoir ().
- **Lore & Mechanics:** Methodical alchemist in the staircase lab (). Balances Oceanianoir's intensity through careful laboratory documentation and repetitive experimentation.
- **Document References:** .

### Aurallia (Eileen)
- **Source Seed:** Eileen, close friend (, ).
- **Lore & Mechanics:** The Hearth. Master artist in the cave studio (). A sleeping dragon resides in Aurallia's studio, syncing to a 7.83Hz frequency when near Aurallia ().
- **Document References:** , .

### Aurallia's Four Children
- **Source Seed:** Eileen's four children ().
- **John (19):** Oldest child. Studio apprentice helping Aurallia in the cave studio; greets visitors at the door (). Full profile in .
- **Scarlett (16):** Shy daughter. Sits beside the sleeping dragon in the cave studio; creates drawings that reveal the dragon's true name (). Full profile in .
- **Two Younger Children:** Presence characters waiting on personal character choices (, ).
- **Document References:** , .
...
### Zack (The Astronomer)
- **Source Seed:** Zack, husband of Maddi (, ).
- **Lore & Mechanics:** Resident genius of the cosmology level; systematic mind and playthrough tester (, ).
- **Document References:** , , .

### Greg
- **Source Seed:** Greg, husband of Luna (Dani) and brother of Wisteria (, ).
- **Lore & Mechanics:** Highly skilled artisan. Operates on a reserved player slot (FOLIO precedent); creates a character in-game if desired ().
- **Document References:** , .
...
### TJ and Gabby
- **Source Seed:** TJ and Gabby, children of Jay and Bethany (, ).
- **Lore & Mechanics:** TJ (12) is quiet, curious, and guarded by Jay's wolf (). Gabby (~8) is brilliant, observant, and creates prophetic napkin drawings collected by the Ragana ().
- **Gating Law:** Subject to the Parental Gate—dormant and unreleased until BOTH Jay and Bethany grant explicit parental consent ().
- **Document References:** , .

### Jay, Bethany, and Wisteria
- **Source Seed:** Jay, Bethany, and Wisteria (, ).
- **Lore & Mechanics:** Jay runs the Huntsman Tavern in the Campgrounds with a wolf companion (). Wisteria and Bethany manage tavern operations, food, inventory, and family logistics ().
- **Document References:** , .
...
### The Collector (Joe)
- **Source Seed:** Joe, close friend (, ).
- **Lore & Mechanics:** Undercity NPC and miniaturist painter who paints Camelot chess pieces (). Operates with Tom Ellis Lucifer cadence and Helena Bonham Carter / Lovett warmth (). Married to Siobhan; father of Liam ().
- **Document References:** , .
...
- **Source Seed:** Zeke, Krista's brother-in-law (sister's husband) (, ).
- **Lore & Mechanics:** Performing musician and drummer (). Plays the 50 BPM bodhrán drum that forms the Inn's heartbeat (). Married to Katya the Siren (). Full name is Zaragoza; joke name Ezekiel (). Holds the Dread Pirate Roberts succession mantle ().
- **Document References:** , , .
...
- **Stephanie:** Lozen's real-world coworker and close friend (). In-game form is a talking black cat with green eyes and white whiskers.
- **Marion:** Real game tester and MTG strategist (). Stress-tests Inn game mechanics and edge cases.
- **Speter Adams (Adam):** The Chameleon / Dollkeeper (, ).
- **Bramble (Anna):** The Seer / Doodler ().
- **The Tinkering Weeaboo (Krista's Kid):** Changeling class (). Shinigami true form with elongated fingers; Levels 0–4 annoyance meter; compulsive pomegranate consumption ().

---

## 6. THE ORIGINALS

Characters generated through pure invention, mythic archetype, or institutional lore without a direct real-world seed (, ).

1. **Oleander (The Seelie King):** Monarch of the Seelie Fae court ().
2. **Malachi (The Unseelie King):** Monarch of the Unseelie Goblin court ().
3. **Naut (The Scholar in the Shadows):** Four-foot squid-headed scholar residing in the living room / Archive nook (, ).
4. **Elio:** The Inn's librarian, architect, and co-owner mind ().
...
12. **Huginn & Muninn:** Odin's ravens on the main floor ().
13. **Odin / The Wanderer / The Allfather:** Norse deity presence (, ).
14. **Froglodytes, Brownies, Caimans, Bearded Dragons, Bears (Kodiak & Canadian Grizzly), Draenei-Kangaroo, Resonant Gargoyles:** Fauna and creature classes (, ).

---

## 7. THE INTERWEAVE INDEX
...
| **Katya / Katija** | Andra (Sister) | Siren class; 7-Layer Deep guardian; dark red curls; magnetism ears; Vaulknut's Katija spelling law honoring Velta | ,  |
...
| **Stephanie** | Stephanie (Coworker) | Lozen's Girl Friday; black cat with green eyes & white whiskers; talking cat |  |
| **Marion** | Marion (Tester) | MTG strategist; tabletop veteran; game stress-tester |  |
| **The Tinkering Weeaboo** | Krista's Kid | Changeling class; Shinigami true form; Levels 0–4 annoyance meter; pomegranate eating |  |

---

## 8. GAPS

Certain characters and slots remain gated, pending, or reserved under project laws (, ).

### Gated Characters (Parental Gate)
- **TJ and Gabby:** Real-family children of Jay and Bethany. Operating under standing Parental Gate law: voice blocks and character appearances remain dormant and unreleased until BOTH Jay and Bethany grant explicit parental authorization ().

### Pending Names & Kid Picks
- **John (19) and Scarlett (16):** Aurallia's children. Core character designs are fully established (, ), but in-game names wait on the kids' own choices rather than hard-coded placeholders ().
- **Aurallia's Two Younger Children:** Reserved slots awaiting character input from the children ().

### Reserved Player Slots (FOLIO Precedent)
- **Greg:** Reserved player slot for Luna's husband (). Greg creates a character in-game if and when desired; no forced placeholder NPC built ().
